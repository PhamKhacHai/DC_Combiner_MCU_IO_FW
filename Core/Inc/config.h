...
#define CONFIG_CAN_DIAG_REQUEST_ID_BASE (0x530U)
#define CONFIG_CAN_DIAG_RESPONSE_ID_BASE (0x540U)

#define CONFIG_CAN_COMMAND_DLC (1U)
#define CONFIG_CAN_STATUS_DLC (8U)
#define CONFIG_CAN_HEARTBEAT_DLC (8U)
#define CONFIG_CAN_DIAG_REQUEST_DLC_MIN (3U)
#define CONFIG_CAN_DIAG_RESPONSE_DLC (8U)
...
/* Diagnostic counter request/response protocol */
#define CONFIG_CAN_DIAG_COMMAND_INDEX (0U)
#define CONFIG_CAN_DIAG_COUNTER_ID_INDEX (1U)
#define CONFIG_CAN_DIAG_GROUP_INDEX (2U)
#define CONFIG_CAN_DIAG_VALUE_INDEX (3U)
#define CONFIG_CAN_DIAG_STATUS_INDEX (7U)

#define CONFIG_CAN_DIAG_COMMAND_READ_COUNTER (0x01U)
#define CONFIG_CAN_DIAG_COMMAND_RESET_ALL_COUNTERS (0x02U)

#define CONFIG_CAN_DIAG_RESPONSE_ERROR (0x80U)
#define CONFIG_CAN_DIAG_RESPONSE_READ_COUNTER (0x81U)
#define CONFIG_CAN_DIAG_RESPONSE_RESET_ALL_COUNTERS (0x82U)

#define CONFIG_CAN_DIAG_STATUS_OK (0x00U)
#define CONFIG_CAN_DIAG_STATUS_INVALID_COMMAND (0x01U)
#define CONFIG_CAN_DIAG_STATUS_INVALID_COUNTER_ID (0x02U)
#define CONFIG_CAN_DIAG_STATUS_INVALID_GROUP (0x03U)
#define CONFIG_CAN_DIAG_STATUS_BAD_DLC (0x04U)
#define CONFIG_CAN_DIAG_STATUS_RESET_MAGIC_INVALID (0x05U)
#define CONFIG_CAN_DIAG_STATUS_INTERNAL_ERROR (0x06U)

#define CONFIG_CAN_DIAG_GROUP_GLOBAL (0xFFU)

#define CONFIG_CAN_DIAG_COUNTER_CONTACTOR_CLOSE (0x01U)
#define CONFIG_CAN_DIAG_COUNTER_CONTACTOR_OPEN (0x02U)
#define CONFIG_CAN_DIAG_COUNTER_FEEDBACK_MISMATCH (0x03U)
#define CONFIG_CAN_DIAG_COUNTER_GROUP_FAULT (0x04U)
#define CONFIG_CAN_DIAG_COUNTER_ON_TIMEOUT_FAULT (0x05U)
#define CONFIG_CAN_DIAG_COUNTER_UNEXPECTED_OFF_FAULT (0x06U)
#define CONFIG_CAN_DIAG_COUNTER_FAULT_CLEAR (0x07U)

#define CONFIG_CAN_DIAG_COUNTER_CAN_COMMAND_RX (0x20U)
#define CONFIG_CAN_DIAG_COUNTER_CAN_TX (0x21U)
#define CONFIG_CAN_DIAG_COUNTER_CAN_RX_ERROR (0x22U)
#define CONFIG_CAN_DIAG_COUNTER_CAN_TX_ERROR (0x23U)
#define CONFIG_CAN_DIAG_COUNTER_CAN_TIMEOUT (0x24U)
#define CONFIG_CAN_DIAG_COUNTER_FAILSAFE_ENTER (0x25U)
#define CONFIG_CAN_DIAG_COUNTER_DIAG_REQUEST (0x26U)
#define CONFIG_CAN_DIAG_COUNTER_DIAG_ERROR (0x27U)

#define CONFIG_CAN_DIAG_RESET_MAGIC0 (0xA5U)
#define CONFIG_CAN_DIAG_RESET_MAGIC1 (0x5AU)
...
static inline uint32_t Config_CanDiagRequestId(uint8_t node_id)
{
  return CONFIG_CAN_DIAG_REQUEST_ID_BASE + (uint32_t)(node_id & CONFIG_CAN_NODE_ID_MAX);
}

static inline uint32_t Config_CanDiagResponseId(uint8_t node_id)
{
  return CONFIG_CAN_DIAG_RESPONSE_ID_BASE + (uint32_t)(node_id & CONFIG_CAN_NODE_ID_MAX);
}
